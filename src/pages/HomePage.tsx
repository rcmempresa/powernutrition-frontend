...
const HomePage = ({ cart, handleQuickViewOpen }) => {
  ...
  // NOVO: useEffect para buscar campanhas ativas
  useEffect(() => {
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-400 mb-8 leading-relaxed">
                Leve seus treinos ao próximo nível e acelere a recuperação com a nossa gama de aminoácidos premium. Essenciais para a reparação muscular e o crescimento, são a chave para um desempenho consistente e resultados duradouros.
              </p>
              <div className="flex items-center space-x-4">
                <button
                  className="bg-red-600 text-white px-8 py-3 rounded-lg font-medium hover:bg-red-700 hover:shadow-lg hover:shadow-red-700/30 transition-all flex items-center"
            ...
            <motion.div
              ...
              viewport={{ once: true, amount: 0.3 }}
              transition={{ duration: 0.8 }}
              className="h-[450px] md:h-[550px] lg:h-[650px]"
            >
              <img
                src="/aminoacidos.webp"
                alt="Pote de suplementos de aminoácidos"
